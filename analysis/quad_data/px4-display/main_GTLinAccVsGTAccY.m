...
k=1;
fig.p(k).title.str  = 'acceleration in y direction $\left[{}_0\mathbf{a}_\mathrm{lin}\right]_2$';
fig.p(k).x          = t;
fig.p(k).y{1}       = GT.a;
fig.p(k).y{2}       = a;
...
fig.p(k).ylabel.str = '$\left[{}_0\mathbf{a}_\mathrm{lin}\right]_2$ is acceleration in $\frac{\mathrm{m}}{\mathrm{s}^2}$';
