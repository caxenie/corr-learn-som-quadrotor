...
k=1;
fig.p(k).title.str  = 'net linear acceleration in z direction $\left[\mathbf{a}_\mathrm{net}\right]_3$';
fig.p(k).x          = t;
fig.p(k).y{1}       = a;
fig.p(k).y{2}       = a_filt;
...
fig.p(k).ylabel.str = '$\left[\mathbf{a}_\mathrm{net}\right]_3$ is acceleration in $\frac{\mathrm{m}}{\mathrm{s}^2}$';
