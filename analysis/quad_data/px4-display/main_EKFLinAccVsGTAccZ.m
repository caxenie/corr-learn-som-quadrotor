...
k=1;
fig.p(k).title.str  = 'acceleration in z direction $a_\mathrm{z}$';
fig.p(k).x          = t;
fig.p(k).y{1}       = GT.a;
fig.p(k).y{2}       = a;
...
fig.p(k).ylabel.str = '$a_\mathrm{z}$ is acceleration in $\frac{\mathrm{m}}{\mathrm{s}^2}$';
